#!/bin/sh
# $Header: JFSBIP_DB.sh,v 1.0 2014/09/11 14:56:02 $
#
# ---------------------------------------------------------------------------
...
backup current controlfile tag JFSBIP_CONTROLFILEBKP FORMAT '%d_%U_controlfile';
#backup archivelog all not backed up 1 times tag JFSBIP_ARCHIVEBKP format '%d_%T_%s_%p_ARCHIVE';
